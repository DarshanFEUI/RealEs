...
const Testimonials = () => {
  return (
    <div className="container mx-auto my-20 border-b pb-10 px-6">
        ...
        {TESTIMONIALS.map((testimonial, index) => (
            ...
            <div key={index} className="w-full p-2 md:w-1/2 lg:w-1/4">
                ...
                <div className="flex items-center">
                    <Image className="mr-4 rounded-full border-4 border-neutral-400" src={testimonial.image}
                    width={80}
                    height={80}
                    ...
                    <span className="text-sm text-neutral-600">{testimonial.instagram}</span>
                    </div>
                </div>
